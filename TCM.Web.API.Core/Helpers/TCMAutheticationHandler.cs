...
{
    public class TCMAutheticationHandler : AuthenticationHandler<JwtBearerOptions>
    {
        private OpenIdConnectConfiguration _configuration;

        public TCMAutheticationHandler(IOptionsMonitor<JwtBearerOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock)
    ...
    public static class TCMAuthenticationDefaults
    {
        public const string AuthenticationScheme = "TCMAuth";
    }
    public static class TCMAuthenticationExtensions
    {
        public static AuthenticationBuilder AddTCMAuthetication(this AuthenticationBuilder builder)
        {
            return AddTCMAuthetication(builder, TCMAuthenticationDefaults.AuthenticationScheme, _ => { });
        }

        public static AuthenticationBuilder AddTCMAuthetication(this AuthenticationBuilder builder, string authenticationScheme)
            
        {
            return AddTCMAuthetication(builder, authenticationScheme, _ => { });
        }

        public static AuthenticationBuilder AddTCMAuthetication(this AuthenticationBuilder builder, Action<JwtBearerOptions> configureOptions)
           
        {
            return AddTCMAuthetication(builder, TCMAuthenticationDefaults.AuthenticationScheme, configureOptions);
        }

        public static AuthenticationBuilder AddTCMAuthetication(this AuthenticationBuilder builder, string authenticationScheme, Action<JwtBearerOptions> configureOptions)
           
        {

            return builder.AddScheme<JwtBearerOptions, TCMAutheticationHandler>(
